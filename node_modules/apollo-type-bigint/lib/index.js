...
class GraphQLBigInt extends _graphql.GraphQLScalarType {
  constructor(mode = "bigInt") {
    const MAX_INT = Number.MAX_SAFE_INTEGER;
    const MIN_INT = Number.MIN_SAFE_INTEGER;
    const safeDescription = "The `BigInt` scalar type represents non-fractional signed whole numeric values." + "BigInt can represent values between -(2^53) + 1 and 2^53 - 1.";
    const bigIntDescription = "The `BigInt` scalar type represents non-fractional signed whole numeric values." + "BigInt can represent values between -(2^63) + 1 and 2^63 - 1.";
